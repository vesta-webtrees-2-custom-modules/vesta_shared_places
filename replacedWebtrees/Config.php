...
class Config {
  ...
  public static function emptyFacts(): array {
    return [
        ...
        'HUSB',
        'IMMI',
        //'MAP', //[RC] adjusted: yes, it's empty, but it has a substructure, so it's different from those other empty facts
        //(adjusted because we don't want to show 'yes' here via FunctionsPrint::formatFactDate)
        'MARB',
        'MARC',
        'MARL',
        'MARR',
